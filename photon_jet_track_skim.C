    ...
    if (isMC) {
      ...
      if (isHI) {
        if (pthat >= 14.95 && pthat < 30.)
          ...
          pjtt.weight = 0.430662;
        else if (pthat >= 50. && pthat < 80.)
          pjtt.weight = 0.160472;
        else if (pthat >= 80. && pthat < 120.)
          pjtt.weight = 0.0473137;
        else if (pthat >= 120.)
        ...
        if (isFlt50Sample) {
            if (pthat >= 30. && pthat < 50.)
              pjtt.weight = 0.999577;
            else if (pthat >= 50. && pthat < 80.)
              pjtt.weight = 0.377152;
            else if (pthat >= 80. && pthat < 120.)
              pjtt.weight = 0.129224;
            else if (pthat >= 120.)
              pjtt.weight = 0.0444307;
            else
              pjtt.weight = 0;
        }
      } else {
        if (pthat >= 14.95 && pthat < 30.)
          ...
          pjtt.weight = 0.102211;
        else if (pthat >= 50. && pthat < 80.)
          pjtt.weight = 0.0218972;
        else if (pthat >= 80. && pthat < 120.)
          pjtt.weight = 0.00460337;
        else if (pthat >= 120.)
          pjtt.weight = 0.0033236;
        else
          pjtt.weight = 0;
      }
    } else {
