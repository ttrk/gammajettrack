...
## sys var plots
./run-ff-plot-results.sh 60 9999 30 1 0 1 pbpbdata sysvar_fitfnc $inputDir recoreco
./run-ff-plot-results.sh 60 9999 30 1 1 1 pbpbdata sysvar_fitfnc $inputDir recoreco
./run-ff-plot-results.sh 60 9999 30 1 0 1 ppdata sysvar_fitfnc $inputDir recoreco
./run-ff-plot-results.sh 60 9999 30 1 1 1 ppdata sysvar_fitfnc $inputDir recoreco
