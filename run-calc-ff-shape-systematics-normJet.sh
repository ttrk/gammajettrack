...
mv sys_hjs_normJet_final_${sample}_${type}_*_*-data_${phoetmin}_${jetptmin}_gxi${gammaxi}_obs2_ffjs.png ${sysDir}
...
cp ${sysDir}"/"jssys_data_${phoetmin}_${jetptmin}_gxi${gammaxi}_obs2_ffjs-systematics.root .
./calc_ratio_systematics.exe js_normJet $SYSFILELIST $SYSHISTLIST jssys_data_${phoetmin}_${jetptmin}_gxi${gammaxi}_obs2_ffjs
mv sys_hjs_normJet_final_*_*_*-jssys_data_${phoetmin}_${jetptmin}_gxi${gammaxi}_obs2_ffjs.png ${sysDir}
mv jssys_data_${phoetmin}_${jetptmin}_gxi${gammaxi}_obs2_ffjs-systematics.root ${sysDir}
