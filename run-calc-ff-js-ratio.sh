...
SYSTEMATICPP=(NOM       jes_up jes_down jer pes iso ele_rej purity_up purity_down tracking_up tracking_down NOM       NOM         longrange NOM            NOM            NOM phoeffcorr NOM       NOM         NOM)
